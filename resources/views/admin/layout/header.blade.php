                        ...
                        <div class="widget-content-wrapper">
                           <div class="widget-content-left">
                              <div class="btn-group">
                                 ...
                                 <img width="42" class="rounded-circle" src="{{asset('storage/app/public/profile').'/'.Auth::user()->image}}" alt="">
                                 <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                 </a>
                                 <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                    <div class="dropdown-menu-header">
                                       <div class="dropdown-menu-header-inner bg-info">
                                          <?php $layout = asset('public/atheme/assets/images/dropdown-header/city3.jpg');?>
                                          <div class="menu-header-image opacity-2" style="background-image: url('{{$layout}}');"></div>
                                    ...
                                    <div class="scroll-area-xs" style="height: auto;">
                                       <div class="scrollbar-container ps">
                                          <ul class="nav flex-column">
                                             ...
                                             <li class="nav-item-header nav-item"><a href="{{route('my-account')}}" style="color: #444054;"> <i class="fa fa-user" style="margin-right:5px"></i>  My Account</a>
                                             </li>
                                              <li class="nav-item-header nav-item"><a href="{{route('change-password')}}" style="color: #444054;"><i class="fa fa-key" style="margin-right:5px"></i> Change Password</a>
                                             </li>
                                          </ul>
                                       </div>
                                    </div>
