...
<script type="text/javascript">
 ...
 function delete_record(url){
         var msg = "Are you sure you want to delete this Car?";
         if (confirm(msg)) {                
 ...
 function syncdata(){
     ...
     $.ajax({
              ...
              success: function(response){
                  ...
                  var processed_records = str.new_record+str.update_record.length;
                  ...
                  var txt = '<p>Sync started at '+str.start_datetime+'.</p><p>Total number of records '+str.total_record+'.</p><div id="report_list">'+txdemo+'</div><p>'+processed_records+' records processed successfully.</p><p>Records with stock numbers '+txdemo1+' already existed and were updated.</p>'
                  if(str.fail!=0){
                    txt = txt + '<p>'+str.fail+' records failed. Details above.</p>';
                  }
